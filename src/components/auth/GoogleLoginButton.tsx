...
// Presentational button that kicks off the Google OAuth flow. Navigating to the
// BFF start route (a full-page redirect) is required — the OAuth handshake
// cannot happen over fetch — so this is a real navigation, not an API call.
...
export default function GoogleLoginButton() {
  // Full-page navigation to the BFF start route. `<Link>` is deliberately not
  // used: this is a server redirect handshake, not client-side routing.
  const startLogin = () => {
